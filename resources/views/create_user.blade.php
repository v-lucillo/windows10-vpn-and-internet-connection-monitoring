...
<div class="row row-cards">
  <div class="col-md-12">
    <div class="card">
      ...
      <div class="card-body">
        <form action="{{route('admin.submit_user')}}" method="POST">
          @csrf
          ...
          <div class="form-group mb-3 row">
               ...
               <div class="form-selectgroup-boxes row mb-3">
                  <div class="col-lg-6">
                    <label class="form-selectgroup-item">
                      <input type="radio" name="user_lvl" value="1" class="form-selectgroup-input" checked="">
                  ...
                  <div class="col-lg-6">
                    <label class="form-selectgroup-item">
                      <input type="radio" name="user_lvl" value="0" class="form-selectgroup-input">
                      <span class="form-selectgroup-label d-flex align-items-center p-3">
                        <span class="me-3">
                          <span class="form-selectgroup-check"></span>
                        </span>
           ...
           <div class="user_lvl_priv">
             <!-- <div class="form-group mb-3 row">
               ...
               <div class="col">
                 <select name = "master_station[]" class="form-select"></select>
             ...
             <div class="form-group mb-3 row">
               ...
               <div class="col">
                 <select name = "station[]" class="form-select"></select>
                 @error('call_sign')
                       <div class="text-muted font-italic">
                         <small class="text-warning font-weight-700">{{$message}} </small>
                       </div>
